/*
 * RAWAEA ERP — MAIN11 OWNER SURGICAL REPLACEMENTS
 * Date: 2026-09-12
 * Source of Truth: Current/PWA/main2/main11.md
 * Current source SHA: 2adfc787c3e5f0ca56abfcc85232e7a971773c3b
 *
 * Owner must apply these whole-module replacements to main11.md.
 * Production dependencies were implemented separately in Supabase migration:
 * 20260912_main11_hr_crm_gold_capabilities_20260912
 */

const MAIN11_OWNER_SURGICAL_REPLACEMENTS_20260912 = {
  source: 'Current/PWA/main2/main11.md',
  source_sha: '2adfc787c3e5f0ca56abfcc85232e7a971773c3b',
  replacements: [
    {
      id: 'M11-01',
      title: 'استبدال وحدة HR الهيكلية بوحدة HR فعلية',
      line_range: '1–185',
      element: 'var RW_HR = (function() { ... })();',
      delete_instruction: 'ابحث عن أول سطر يبدأ بـ // ============================================================ ثم السطر التالي RW_HR – الموارد البشرية (HR) - الوحدة المتقدمة، واحذف كامل بلوك RW_HR حتى السطر الكامل window.RW_HR = RW_HR; بما فيه هذا السطر. لا تحذف أي سطر من RW_CRM.',
      replacement: `// ============================================================
// RW_HR – الموارد البشرية (HR) - وحدة تشغيلية متكاملة
// ============================================================
var RW_HR = (function() {
    'use strict';
...
window.RW_HR = RW_HR;`
    ...
    {
      id: 'M11-02',
      title: 'استبدال CRM بمتابعة عملاء فعلية ومؤمنة ومتصلة بالـTenant',
      line_range: '189–330',
      element: 'var RW_CRM = (function() { ... })();',
      delete_instruction: 'ابحث عن السطر الكامل var RW_CRM = (function() { واحذف بلوك RW_CRM كاملًا حتى السطر الكامل window.RW_CRM = RW_CRM; ثم الصق البديل التالي. لا تحذف bindEvents الذي يأتي بعده.',
      replacement: `// ============================================================
