-- RAWAEA ERP — DirectReturn mobile-branch canonical convergence
-- Production-applied: 2026-09-22
-- Existing manual-voucher RPC contract preserved.

BEGIN;

CREATE OR REPLACE FUNCTION public.post_manual_stock_voucher_atomic_core_20260828(
  p_company_id uuid,
  p_voucher_code text,
  p_operation text,
  p_user_email text,
