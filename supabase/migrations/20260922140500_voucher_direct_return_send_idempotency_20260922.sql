-- RAWAEA ERP — DirectReturn SEND idempotency convergence
-- Applied in Production during the 2026-09-22 Warehouse Vouchers closure.
-- Existing public API/writer contract preserved; only the existing core definition is replaced.
...
REVOKE ALL ON FUNCTION public.send_stock_voucher_atomic_core_20260828(uuid,text,text)
FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.send_stock_voucher_atomic_core_20260828(uuid,text,text)
TO service_role;