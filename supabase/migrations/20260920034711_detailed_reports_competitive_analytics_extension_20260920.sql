-- RAWAEA ERP
-- Detailed Reports competitive analytics extension
-- Canonical replay of Production migration 20260920034711
-- Adds read-only report keys: inventory_abc, logistics_performance.
