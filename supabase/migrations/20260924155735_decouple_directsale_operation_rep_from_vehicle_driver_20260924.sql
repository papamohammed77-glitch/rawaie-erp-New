-- RAWAEA ERP — DirectSale operation/vehicle coupling removal
-- Production migration: 20260924155735_decouple_directsale_operation_rep_from_vehicle_driver_20260924
-- Exact Production change: DirectSale no longer requires vehicle.driver_id to equal the operation representative.
-- DirectReturn driver coupling is intentionally preserved.
