...
def protect_inline_script_end_tags(source: str) -> str:
    # HTML tokenization treats a raw </script ...> as the end of the enclosing
    # script even when it appears inside a JavaScript string/template/regex.
    # Escape every embedded terminator while preserving the JavaScript value
    # (</script> remains the runtime string value because \/ escapes '/').
